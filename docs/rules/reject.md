# import/reject: Enforce a convention in module import order
...
```js
"import/reject": ["error", {"groups": ["index", "sibling", "parent", "internal", "external", "builtin"]}]
```
...
```js
/* eslint import/reject: ["error", {"newlines-between": "always"}] */
import fs from 'fs';
import path from 'path';
import index from './';
...
```js
/* eslint import/reject: ["error", {"newlines-between": "always-and-inside-groups"}] */
import fs from 'fs';
...
```js
/* eslint import/reject: ["error", {"newlines-between": "never"}] */
import fs from 'fs';
import path from 'path';
